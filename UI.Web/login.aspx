    ...
    <body class="text-center">
        <form class="form-signin" id="bodyForm" runat="server">
            ...
            <div class="text-danger">
                <asp:Label ID="lblBadUser" runat="server" Visible="false">Usuario incorrecto</asp:Label>
                <asp:Label ID="lblBadPass" runat="server" Visible="false">Contraseña incorrecta</asp:Label>
            </div>
