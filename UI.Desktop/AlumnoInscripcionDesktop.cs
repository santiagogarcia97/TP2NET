...
namespace UI.Desktop
{
    ...
    {
        public enum AccessForm { Abierto, Restringido };
        private AccessForm _access;
        private AlumnoInscripcion _inscripcionActual;

        public AccessForm Access {
            get { return _access; }
            set { _access = value; }
        }
        ...
        public AlumnoInscripcionDesktop(ModoForm modo, AccessForm access) : this()
        {
            Modo = modo;
            Access = access;
        }
        ...
        public AlumnoInscripcionDesktop(ModoForm modo, AccessForm access, int ID) : this()
        {
            Modo = modo;
            Access = access;
